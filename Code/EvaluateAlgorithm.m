...
[wm_img_dwt_svd, rec_wm_dwt_svd, results_dwt_svd] = ...
     EvaluateWatermark('DWT_SVD', @DWT_SVDWatermarkEmbedding, ...
...
[wm_img_dwt_dct, rec_wm_dwt_dct, results_dwt_dct] = ...
    EvaluateWatermark('DWT_DCT', @DWT_DCTWatermarkEmbedding, ...
...
[wm_img_jdwt_dct, rec_wm_jdwt_dct, results_jdwt_dct] = ...
    EvaluateWatermark('jDWT_DCT', @jDWT_DCTWatermarkEmbedding, ...
    @jDWT_DCTWatermarkExtraction, img, watermark, [0 1 1 1 1 1 1 1], 0.4);
figure;
...
[wm_img_rdwt_svd, rec_wm_rdwt_svd, results_rdwt_svd] = ...
    EvaluateWatermark('RDWT_SVD', @RDWT_SVDWatermarkEmbedding, ...
